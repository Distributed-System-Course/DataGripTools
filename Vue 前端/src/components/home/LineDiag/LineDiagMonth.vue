...
export default {
  ...
  methods: {
    ...
    query () {
      this.$axios
        .post('/linediagmonth', this.linemonth).then(resp => {
          if (resp) {
            console.log(resp)
            this.huifengdata = resp.data.huifengdata
            this.dayuedata = resp.data.dayuedata
            this.wandadata = resp.data.wandadata
            this.gongshangdata = resp.data.gongshangdata
    ...
    //   let date = new Date()
    //   this.$axios
    //     .post('/linediagmonth', date).then(resp => {
    //       if (resp) {
